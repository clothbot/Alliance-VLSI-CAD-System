...
void XpatBuildPanel( Father, Panel ) 

     Widget           Father;
     XpatPanelItem  *Panel;
{
  Arg                   Args[13];
  XpatPanelButtonItem *Button;
  char                 *Label;
  int                   Counter;
  int                   Fraction;
  int                   X1;
        ...
        Counter++ )
  {
    ...
    {
      ButtonPixmap = XpatCreatePixmap( Father, 
    ...
    if ( Label != XpatPanelButtonDisable )
    {
