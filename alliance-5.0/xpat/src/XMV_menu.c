     ...
     caddr_t CallData;
{
  ...
  if ( XpatFirstViewLayer )
  {
    XpatFirstViewLayer = 0;

    XpatInitializeLayer();
  }

  XpatEnterPanel( &XpatViewLayerPanel );
     ...
     caddr_t CallData;
{
  ...
  XpatEnterPanel( &XpatViewGridPanel );
     ...
     caddr_t CallData;
{
  ...
  XpatEnterPanel( &XpatViewArrowsPanel );
     ...
     caddr_t CallData;
{
  ...
  XpatEnterPanel( &XpatViewZoomPanel );
