...
# ifndef XPAT_VIEW_DIALOG
# define XPAT_VIEW_DIALOG
...
\------------------------------------------------------------*/
  ...
  extern XpatDialogItem XpatViewZoomSetDialog;
  extern XpatDialogItem XpatViewZoomGotoDialog;
  extern XpatDialogItem XpatViewMoveSetDialog;
  extern XpatDialogItem XpatViewGridXDialog;
  extern XpatDialogItem XpatViewGridYDialog;
