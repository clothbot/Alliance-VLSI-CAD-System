     ...
     caddr_t CallData;
{
  ...
  XvpnChangeEditMode( XVPN_EDIT_CONNECTED,
                      XvpnPromptEditConnected );
  autend();
}
     ...
     caddr_t CallData;
{
  ...
  XvpnEnterDialog( &XvpnSearchObjectDialog );
...
void CallbackEditDescription( MyWidget, ClientData, CallData )
     ...
     caddr_t CallData;
{
  ...
  XvpnEnterPanel( &XvpnEditDescriptionPanel );
