...
# ifndef XVPN_VIEW_DIALOG
# define XVPN_VIEW_DIALOG
...
\------------------------------------------------------------*/
  ...
  extern XvpnDialogItem XvpnViewZoomSetDialog;
  extern XvpnDialogItem XvpnViewZoomGotoDialog;
  extern XvpnDialogItem XvpnViewMoveSetDialog;
  extern XvpnDialogItem XvpnViewGridXDialog;
  extern XvpnDialogItem XvpnViewGridYDialog;
