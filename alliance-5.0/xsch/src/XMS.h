...
\------------------------------------------------------------*/
  ...
  extern XschMenuItem  XschSetupMenu[];
  extern XschPanelItem XschSetupInformationsPanel;

  extern int XschSetupInformationsDefaultValues[ 5 ];
...
\------------------------------------------------------------*/
  ...
  extern void XschLoadTopLevelConfig();
