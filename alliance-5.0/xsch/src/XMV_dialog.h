...
# ifndef XSCH_VIEW_DIALOG
# define XSCH_VIEW_DIALOG
...
\------------------------------------------------------------*/
  ...
  extern XschDialogItem XschViewZoomSetDialog;
  extern XschDialogItem XschViewZoomGotoDialog;
  extern XschDialogItem XschViewMoveSetDialog;
  extern XschDialogItem XschViewGridXDialog;
  extern XschDialogItem XschViewGridYDialog;
