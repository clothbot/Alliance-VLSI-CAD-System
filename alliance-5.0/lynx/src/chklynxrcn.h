...
void GrgChkInConFEqui __P((lofig_list*));
/*************************************************************
...
void GrgChkOutConVia __P((lofig_list*, short));
/*************************************************************
...
void Grgdisplay_datain __P((lofig_list*));


void Grgdisplayrdscon __P((ptype_list*, long));


void dbg_affrec __P((rdsrec_list*));
