...
/* ###--------------------------------------------------------------### */
/* function	: pat_addpacom						*/
/* description	: create an empty PACOM (comment) structure at the top	*/
/*		  of a list						*/
...
unsigned short  position;	/* # of statements. since last comment	*/

  {
  struct pacom *ptcom;

  ptcom           = (struct pacom *) mbkalloc (sizeof(struct pacom));
  ptcom->TEXT     = text;
