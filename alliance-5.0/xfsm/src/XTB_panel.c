...
void XfsmBuildPanel( Father, Panel ) 

     Widget           Father;
     XfsmPanelItem  *Panel;
{
  Arg                   Args[13];
  XfsmPanelButtonItem *Button;
  char                 *Label;
  int                   Counter;
  int                   Fraction;
  int                   X1;
        ...
        Counter++ )
  {
    ...
    {
      ButtonPixmap = XfsmCreatePixmap( Father, 
    ...
    if ( Label != XfsmPanelButtonDisable )
    {
