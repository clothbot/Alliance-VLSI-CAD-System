...
\------------------------------------------------------------*/
  ...
  char *XgraPanelButtonDisable = "xxxx";
...
void XgraBuildPanel( Father, Panel ) 

     Widget           Father;
     XgraPanelItem  *Panel;
{
  Arg                   Args[13];
  XgraPanelButtonItem *Button;
  char                 *Label;
  int                   Counter;
  int                   Fraction;
  int                   X1;
        ...
        Counter++ )
  {
    ...
    {
      ButtonPixmap = XgraCreatePixmap( Father, 
    ...
    if ( Label != XgraPanelButtonDisable )
    {
