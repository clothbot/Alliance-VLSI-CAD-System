...
# ifndef GRAAL_VIEW_DIALOG
# define GRAAL_VIEW_DIALOG
...
\------------------------------------------------------------*/
  ...
  extern GraalDialogItem GraalViewZoomSetDialog;
  extern GraalDialogItem GraalViewZoomGotoDialog;
  extern GraalDialogItem GraalViewMoveSetDialog;
  extern GraalDialogItem GraalViewGridXDialog;
  extern GraalDialogItem GraalViewGridYDialog;
